...
<body>
    ...
    <tbody><tr>
        ...
        <td class="container" width="600">
            ...
            <header>
            <p
					style="font-family: 'Lato', sans-serif;; font-size: 25px; color: Red; text-align: center; position: relative; top: -7px;">Payment Denied!
					</p>
                            ...
                            <table width="100%" >
                                ...
                                <tr>
                                    <td class="content-block">
                                        <table class="invoice">
                                            <tbody><tr>
                                                <td>July<br>012-3456789<br>June 01 2015</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table class="invoice-items" >
                                                        ...
                                                        <tr>
                                                            <td>Fuel Type</td>
                                                            <td class="alignright">Ron 97</td>
                                                        </tr>
                                                        <tr class="total">
                                                            <td class="alignright" width="70%">Total</td>
                                                            <td class="alignright">RM 136.00</td>
                                                        </tr>
                                                    </tbody></table>
                                                </td>
                                            </tr>
